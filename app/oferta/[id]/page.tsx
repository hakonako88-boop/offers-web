  ...
  return (
    <main className="offerPage">
      ...
      <article className="offerArticle shell">
        ...
        <section className="offerTelegramJoin" aria-labelledby="offer-telegram-title">
          <div className="offerTelegramIcon" aria-hidden="true">↗</div>
          <div><p className="eyebrow"><span aria-hidden="true" />ALERTAS GRATIS</p><h2 id="offer-telegram-title">Recibe el próximo chollo antes de que se agote.</h2><p>Entra al canal de Chollos al Día para recibir ofertas seleccionadas, precios claros y cupones cuando estén disponibles. No necesitas dejar tu correo.</p></div>
          <a href="https://t.me/aldiachollos" target="_blank" rel="noreferrer">Unirme a @aldiachollos <span aria-hidden="true">→</span></a>
        </section>
